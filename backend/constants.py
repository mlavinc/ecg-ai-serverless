...
# Static evaluation metrics/metadata, regenerated by backend/models/train.py.
# Kept as a relative path ("data/models/...") on purpose: it resolves both
# locally (cwd = repo root) and inside the flat Lambda package (cwd =
# /var/task), mirroring the "data/mock" convention used for the test record.
METRICS_RELATIVE_PATH = "data/models/model_metadata.json"
