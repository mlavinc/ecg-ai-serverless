        ...
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <MetricCard
              ...
              value={metrics.macro_f1_score != null ? formatPercent(metrics.macro_f1_score) : 'N/A'}
            />
            <MetricCard icon={Database} label="Dataset size" value={String(metrics.dataset_size ?? 'N/A')} />
          </div>
              ...
              <CardContent>
                {metrics.per_class ? (
                  ...
                  <p className="text-muted-foreground text-sm">
                    Not available yet. Per-class precision/recall/F1 are generated by re-running{' '}
          ...
          <Card>
            ...
            <CardContent>
              {metrics.confusion_matrix ? (
                ...
                <p className="text-muted-foreground text-sm">
                  Not available yet. The raw PhysioNet dataset is not bundled in this repository.
